...
// css plugin
(function(j){function r(){var a;a=f[z]("link");a.rel="stylesheet";a.type="text/css";return a}function A(a,c,e){s.push({url:a,cb:c,eb:function(){e(Error(t))}});a=u.shift();!a&&v.length<B&&(a=f.createElement("style"),v.push(a),n.appendChild(a));a&&q(a)}function q(a){var c,e;c=s.shift();e=a.styleSheet;c?(a.onload=function(){c.cb(c.ss);q(a)},a.onerror=function(){c.eb();q(a)},c.ss=e.imports[e.addImport(c.url)]):(a.onload=a.onerror=g,u.push(a))}function w(a,c,e){if(!h.load){var d;var b,k;if(!a.href||f.readyState&&
"complete"!=f.readyState)d=!1;else{d=!1;try{if(b=a.sheet)k=b.cssRules,d=null===k,!d&&k&&(b.insertRule("-curl-css-test {}",0),b.deleteRule(0),d=!0)}catch(C){d="[object Opera]"!=Object.prototype.toString.call(window.opera)&&/security|denied/i.test(C.message)}}d?e(a.sheet):a.onload==g||!a.onload||x(function(){w(a,c,e)},c)}}function D(a,c,e,d){var b;b=r();var k=function(){if(b.onload!=g&&b.onload){b.onload=b.onerror=g;var a=function(){!f.readyState||"complete"==f.readyState?c(b.sheet):x(a,10)};a()}};
b.onload=function(){h.load=h.load||!0;k()};w(b,d,k);b.onerror=function(){h.error=h.error||!0;b.onload!=g&&b.onload&&(b.onload=b.onerror=g,e(Error(t)))};b.href=a;n.appendChild(b)}function g(){}var z="createElement",x=j.setTimeout,f=j.document,n;j=f&&f.createStyleSheet&&!(10<=f.documentMode);var v=[],u=[],s=[],B=12,y,t="HTTP or network error.",h={};f&&(n=f.head||f.getElementsByTagName("head")[0],y=j?A:D);define('css',{normalize:function(a,c){var e,d;if(!a)return a;e=a.split(",");d=[];for(var b=0,f=e.length;b<
f;b++)d.push(c(e[b]));return d.join(",")},load:function(a,c,e,d){function b(a){1<l.length&&g.push(a);0==--j&&e(1==l.length?a:g)}function f(a){(e.reject||function(a){throw a;})(a)}var g,l,h,j,p;g=[];l=(a||"").split(",");h=d.cssWatchPeriod||50;d=d.cssNoWait;j=l.length;for(p=0;p<l.length;p++){a=l[p];var m;a=c.toUrl(a);a=a.lastIndexOf(".")<=a.lastIndexOf("/")?a+".css":a;d?(m=r(),m.href=a,n.appendChild(m),b(m.sheet||m.styleSheet)):y(a,b,f,h)}},"plugin-builder":"./builder/css",pluginBuilder:"./builder/css"})})(this);
